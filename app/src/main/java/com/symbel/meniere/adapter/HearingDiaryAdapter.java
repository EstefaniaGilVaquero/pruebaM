...
public class HearingDiaryAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        try {
            ...
            viewHolder.txtLeft05.setText(arrayHearingEntries.get(position).left05_a + " ± " +arrayHearingEntries.get(position).left05_b);
            viewHolder.txtLeft1.setText(arrayHearingEntries.get(position).left1_a + " ± " +arrayHearingEntries.get(position).left1_b);
            viewHolder.txtLeft2.setText(arrayHearingEntries.get(position).left2_a + " ± " +arrayHearingEntries.get(position).left2_b);
            viewHolder.txtLeft4.setText(arrayHearingEntries.get(position).left4_a + " ± " +arrayHearingEntries.get(position).left4_b);
            viewHolder.txtRigth05.setText(arrayHearingEntries.get(position).rigth05_a + " ± " +arrayHearingEntries.get(position).rigth05_b);
            viewHolder.txtRigth1.setText(arrayHearingEntries.get(position).rigth1_a + " ± " +arrayHearingEntries.get(position).rigth1_b);
            viewHolder.txtRigth2.setText(arrayHearingEntries.get(position).rigth2_a + " ± " +arrayHearingEntries.get(position).rigth2_b);
            viewHolder.txtRigth4.setText(arrayHearingEntries.get(position).rigth4_a + " ± " +arrayHearingEntries.get(position).rigth4_b);
